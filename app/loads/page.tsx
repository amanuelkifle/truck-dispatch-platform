...
export default async function LoadsPage() {
  ...
  const loads = organizationId
    ? await query<LoadRow>(
        `select l.id, l.load_number, b.name as broker_name, c.name as carrier_name,
                t.truck_number, (dr.first_name || ' ' || dr.last_name) as driver_name,
                l.origin, l.destination, l.pickup_date, l.delivery_date,
                l.rate, l.loaded_miles, l.deadhead_miles, l.status
         from loads l
